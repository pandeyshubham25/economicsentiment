...
def getFilderedNews(startDate, endDate, lemma=True, stemming = False, stopw = False, jsonFile = "newsAll.json", keywords = []):
...
finalOutput = getFilderedNews("2020-01-01", "2020-01-02", keywords = ["TRUMP"])
print(finalOutput)
